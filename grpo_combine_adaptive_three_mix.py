...
from trainer import MultiModalGRPOTrainer
from prompt import *
from reward import *
...
def main(script_args, training_args, model_args):
    ...
    reward_funcs_registry = {
        "accuracy": accuracy_reward,
        "format": format_reward_adaptive_three_check,
        "reason": reasoning_steps_reward,
        "length": len_reward,
    }
    ...
    if script_args.dataset_name.endswith('.json'):
        ...
        def make_conversation_sat(example, base_model_prompt=False):
            ...
            if base_model_prompt:
                ...
                QUESTION_TEMPLATE = ''''{Question}\n Please first identify whether this problem requires intermediate thinking or not and output the results in <check> </check>. In <check> </check>, only output two cases: need thinking or not need thinking. Note that perception tasks do not need thinking and math tasks need thinking. If the problem requires thinking or calculation, output the thinking and calculation process inside <think> </think> tags and the final answer inside <answer> </answer> tags. If no thinking is required, directly output the final answer inside <answer> </answer> tags. Your output should follow one of two cases: (1) '<check> need thinking </check> <think> ... </think> <answer> ... </answer>' or (2) '<check> not need thinking </check> <answer> ... </answer>'. '''
                QUESTION_TEMPLATE_rec = ''''{Question}\n Please first identify whether this problem requires intermediate thinking or not and output the results in <check> </check>. In <check> </check>, only output two cases: need thinking or not need thinking. Note that perception tasks do not need thinking and math tasks need thinking. If the problem requires thinking or calculation, output the thinking and calculation process inside <think> </think> tags and the final answer inside <answer> </answer> tags. If no thinking is required, directly output the final answer inside <answer> </answer> tags. Output the final answer in JSON format inside <answer> </answer> tags. Your output should follow one of two cases: (1) '<check> need thinking </check> <think> ... </think> <answer> ... </answer>' or (2) '<check> not need thinking </check> <answer> ... </answer>'. '''
    ...
    dataset_path = "/mnt/hwfile/gveval/liming/mix_task.json"
